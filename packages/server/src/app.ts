...
/** Directory of built frontend assets, resolved once. Served only when it exists. */
export const webDist = resolve(import.meta.dir, "..", env.WEB_DIST);
export const hasWeb = existsSync(webDist);
